                    ...
                    public void onSuccess(MeV2Response result) {
                        ...
                        if (kakaoAccount != null) {
                            ...
                            if (email != null) {
                                ...
                                globalApplication.setUserEamil(email);
                                globalApplication.setUserId(result.getId());
                            ...
                            if (profile != null) {
                                globalApplication.setUserName(profile.getNickname());
                                globalApplication.setUserThumnail(profile.getThumbnailImageUrl());
